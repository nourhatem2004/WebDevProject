...
namespace WebDevProject.Migrations
{
    ...
    [Migration("20250501125416_InitialIdentitySetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDevProject.Models.Employee", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebDevProject.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebDevProject.Models.Employee", b =>
                {
                    b.HasOne("WebDevProject.Models.Department", "Department")
                        .WithMany("Employees")
